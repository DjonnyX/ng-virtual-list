 ...
 * @link https://github.com/DjonnyX/ng-virtual-list/blob/18.x/projects/ng-virtual-list/src/lib/components/scroller/ng-scroller.component.ts
...
export class NgScrollerComponent extends NgScrollView implements OnDestroy {
  ...
  public readonly langTextDir: Signal<TextDirection>;
  ...
  constructor() {
    ...
    this.show = computed(() => {
      return this.scrollbarShow() && this.scrollbarEnabled() && this.preparedSignal();
    });

    this.langTextDir = toSignal(this._service.$langTextDir ?? TextDirections.LTR) as Signal<TextDirection>;
