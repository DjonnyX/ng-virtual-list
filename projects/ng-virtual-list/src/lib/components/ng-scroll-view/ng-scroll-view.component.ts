 ...
 * @link https://github.com/DjonnyX/ng-virtual-list/blob/15.x/projects/ng-virtual-list/src/lib/components/scroll-view/scroll-view.directive.ts
...
export class NgScrollView extends DisposableComponent implements OnDestroy {
