...
import {
    ...
    MAX_VELOCITIES_LENGTH,
    MAX_VELOCITY_TIMESTAMP, MIN_ACCELERATION, MIN_DELTA, OVERSCROLL_START_ITERATION, SCROLL_EVENT, SCROLL_VIEW_NORMALIZE_VALUE_FROM_ZERO, SMOOTH, SPEED_SCALE, TOP,
} from './const';
 ...
 * @link https://github.com/DjonnyX/ng-virtual-list/blob/18.x/projects/ng-virtual-list/src/lib/components/ng-scroll-view/ng-scroll-view.component.ts
...
export class NgScrollView extends BaseScrollView {
    ...
    protected $horizontalAxisInvertion = this._$horizontalAxisInvertion.asObservable();
    ...
    ngAfterViewInit() {
        ...
        combineLatest([this.$isVertical, this.$langTextDir]).pipe(
            takeUntil(this._$unsubscribe),
            tap(([isVertical, langTextDir]) => {
                ...
                return fromEvent<WheelEvent>(content, WHEEL, { passive: false }).pipe(
                    ...
                    tap(e => {
                        ...
                        const scrollSize = isVertical ? this.scrollHeight : this.scrollWidth,
                            ...
                            delta = isVertical ? e.deltaY : (e.deltaX * (this.horizontalAxisInvertion ? -1 : 1)), dp = (startPos + delta),
            ...
            switchMap(content => {
                return fromEvent<MouseEvent>(content, MOUSE_DOWN, { passive: false }).pipe(
                    ...
                    switchMap(e => {
                        ...
                        let prevClientPositionX: number | null = (e.clientX) * (this.horizontalAxisInvertion ? -1 : 1),
                        ...
                        return fromEvent<MouseEvent>(window, MOUSE_MOVE, { passive: false }).pipe(
                            ...
                            switchMap(e => {
                                const { position: positionX, currentPos: currentPosX, endTime, scrollDelta: scrollDeltaX } =
                                    this.calculatePosition(false, true, this.horizontalAxisInvertion, e, inversion, startClientPosX, startTime, prevClientPositionX, offsetsX, velocitiesX),
            ...
            switchMap(content => {
                return fromEvent<TouchEvent>(content, TOUCH_START, { passive: false }).pipe(
                    ...
                    switchMap(e => {
                        ...
                        this._startPositionX = this.x;
                        this._startPositionY = this.y;
                        let prevClientPositionX: number | null = (e.touches[e.touches.length - 1].clientX) * (this.horizontalAxisInvertion ? -1 : 1),
    ...
    refreshCoordinate(x: number, y: number) {
        ...
        scrollContent.style.transform = matrix3d((this._inversion ? 1 : -1) * x * (this.horizontalAxisInvertion ? -1 : 1) + (this._$isVertical.getValue() ? 0 : this._startLayoutOffset),
