...
import {
  ATTR_AREA_SELECTED, EVENT_FOCUS_IN, EVENT_FOCUS_OUT, EVENT_KEY_DOWN, ITEM_ID, KEY_ARR_DOWN, KEY_ARR_LEFT,
...
export class NgVirtualListItemComponent extends BaseVirtualListItemComponent implements OnInit {
  ...
  constructor() {
    ...
    this._elementRef.nativeElement.setAttribute(ITEM_ID, this.displayId);
  }
