 ...
 * @link https://github.com/DjonnyX/ng-virtual-list/blob/20.x/projects/ng-virtual-list/src/lib/components/ng-list-item/ng-virtual-list-item.component.ts
  ...
  ngOnInit(): void {
    ...
    fromEvent(this.element, EVENT_FOCUS_IN).pipe(
      ...
      tap(e => {
        ...
        this.updateConfig(this._data, this._service.grabbing);
