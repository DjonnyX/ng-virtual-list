import {
  ChangeDetectionStrategy, Component, ComponentRef, ElementRef, inject, input,
...
export class NgVirtualListComponent implements OnInit, OnDestroy {
