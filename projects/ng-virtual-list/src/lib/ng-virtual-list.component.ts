import {
  AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ComponentRef, ElementRef, EventEmitter, inject,
  Input,
  OnDestroy, Output, signal, TemplateRef, ViewChild, ViewContainerRef, ViewEncapsulation,
  WritableSignal,
} from '@angular/core';
