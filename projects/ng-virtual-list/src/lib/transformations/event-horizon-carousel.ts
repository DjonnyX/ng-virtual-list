...
export const eventHorizonСarousel: ItemTransform = (index: number, measures: IRenderVirtualListItemMeasures,
    ...
    result.y = isVertical ? (scrollSize + boundsSizeHalf + itemSizeHalf + (yy * Math.pow(px, 0.5))) : yy;
