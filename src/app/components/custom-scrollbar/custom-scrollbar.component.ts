 ...
 * @link https://github.com/DjonnyX/ng-virtual-list/blob/18.x/src/app/components/custom-scrollbar/custom-scrollbar.component.ts
...
export class CustomScrollbarComponent {
    ...
    constructor() {
        ...
        const _state = toSignal($state);
        effect(() => {
            const params = this.params(), state = _state();
